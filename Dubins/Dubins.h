...
/*
    Function to collect Dubins path points to a vector it is highly not efficient but useful for testing.
    Please use DubinsIterator for better performance in proper use.
*/
